...
import type { ScrollStackItemProps, ScrollStackProps } from "@/types/uiux";
...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  return (
    ...
    >
      <div className={`scroll-stack-inner ${useWindowScroll ? 'pt-4 pb-20' : 'pt-[20vh] px-20 pb-[50rem] min-h-screen'}`}>
        {children}
