...
const clientsList: PartnerItem[] = [
  ...
  },
  {
    ...
    category: "Energy & Oil",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450676/logo-mo-i-cho-kho-i-da-u-mo-i-20220101093239.png",
  },
  {
    id: "pvgas",
    name: "PV GAS",
  ...
  },
  {
    ...
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450675/Logo-EVN-H-1.webp",
  },
  {
    id: "bidv",
    name: "BIDV",
  ...
  },
  {
    ...
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450681/Logo-Vinhomes.webp",
  },
  {
    id: "sun-group",
    name: "Sun Group",
    category: "Tourism & Real Estate",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450674/Log-Sun-group.png.webp",
  },
  {
    id: "damcamau",
...
const mediaPartnersList: PartnerItem[] = [
  {
    ...
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450674/Logo_VOV.svg.webp",
  },
  {
    id: "vtc",
    name: "VTC - Truyền hình KTS",
    category: "Digital Television",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/VTC_official_logo.svg.webp",
  },
  {
    id: "nhandan",
    name: "Báo Nhân Dân",
    category: "National Press",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450678/Logo-NhanDan.png",
  },
  {
    id: "vnexpress",
    name: "VnExpress",
    category: "Digital News",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/VnExpress_logo.png",
  },
  {
    id: "tuoitre",
    name: "Báo Tuổi Trẻ",
    category: "National Press",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/tuoi-tre-logo.webp",
  },
  {
    id: "thanhnien",
    name: "Báo Thanh Niên",
    category: "National Press",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/thanh-nien-logo.webp",
  },
  {
    id: "laodong",
    name: "Báo Lao Động",
    category: "National Press",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450670/bao-lao-dong.png",
  },
  {
    id: "dantri",
    name: "Báo Dân Trí",
    category: "Digital News",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450670/Dan_Tri_logo.svg.webp",
  },
  {
    id: "vietnamnet",
    name: "VietNamNet",
    category: "Digital News",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/Vietnamnet.webp",
  },
  {
    id: "qdnd",
    name: "Báo Quân Đội Nhân Dân",
    category: "National Press",
    logoSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786450670/bao-quan-doi-nhan-dan.webp",
  },
  {
    id: "vtcnews",
    name: "VTC News",
