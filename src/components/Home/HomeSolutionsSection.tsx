...
const solutionsData: SolutionItem[] = [
  ...
  {
    id: "04",
    badge: "MEDIATECH & BRANDING",
    subtitle: "MEDIATECH & BRANDING",
    title: "Truyền thông & MediaTech",
    desc: "Giải pháp truyền thông đa kênh, sản xuất nội dung số sáng tạo và ứng dụng công nghệ tương tác nâng tầm vị thế thương hiệu.",
    link: "/solution",
    accentColor: "#38CFC8",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
