...
const projectsData: SolutionProjectItem[] = [
  ...
  },
  {
    ...
    num: "02",
    category: "BILLBOARD",
    title: "CHIẾN DỊCH BILLBOARD TĨNH TOÀN QUỐC",
    client: "PVNDB",
    desc: "Hệ thống 4 billboard tĩnh đặt tại các nút giao và tuyến quốc lộ huyết mạch – từ cửa ngõ Ninh Bình (QL10) đến trục Bắc Nam qua Thanh Hóa (QL1A), tạo độ phủ thương hiệu liên tục trên hành trình di chuyển của hàng triệu lượt xe mỗi ngày.",
    imageSrc: "https://res.cloudinary.com/s3qilvce/image/upload/v1786452184/img_proj_vinfast.jpg",
    highlights: [
      "4 Billboard – 10 mặt hiển thị, kích thước lớn (16x8m & 20x10m/mặt)",
      "Vị trí chiến lược tại nút giao Cao Bồ (QL10, Ninh Bình) và tuyến QL1A (Hoằng Hóa, Quảng Xương – Thanh Hóa)",
      "Hệ thống 36–45 đèn chiếu sáng/bảng, hoạt động 10 tiếng/ngày – đảm bảo hiển thị xuyên suốt cả ngày lẫn đêm",
    ],
  },
  {
    id: "viettel-liveshow",
