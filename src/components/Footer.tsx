      ...
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <Link href="/home" className="footer-logo" aria-label="QTM - Trang chủ">
              <Image
                src="/logo.png"
                alt="QTM Logo"
                width={180}
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li>
                <Link href="/home">
                  <span className="link-bullet" /> Trang chủ
                </Link>
              </li>
              <li>
                <Link href="/about">
                  <span className="link-bullet" /> Về chúng tôi
                </Link>
              </li>
              <li>
                <Link href="/solution">
                  <span className="link-bullet" /> Giải pháp
                </Link>
              </li>
              <li>
                <Link href="/project">
                  <span className="link-bullet" /> Miss Legacy
                </Link>
              </li>
              <li>
                <Link href="/contact">
                  <span className="link-bullet" /> Liên hệ
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            <h2 className="footer-heading">Giải pháp QTM</h2>
            <ul className="footer-links">
              <li>
                <Link href="/solution">
                  <span className="link-bullet" /> Tư vấn Chiến lược
                </Link>
              </li>
              <li>
                <Link href="/solution">
                  <span className="link-bullet" /> Truyền thông & MediaTech
                </Link>
              </li>
              <li>
                <Link href="/solution">
                  <span className="link-bullet" /> Phát triển Công nghệ
                </Link>
              </li>
              <li>
                <Link href="/solution">
                  <span className="link-bullet" /> Phân tích Dữ liệu
                </Link>
              </li>
              <li>
                <Link href="/project">
                  <span className="link-bullet" /> Sự kiện & Trải nghiệm
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <div className="footer-newsletter">
              ...
              {subscribed && (
                <p className="newsletter-msg">✓ Cảm ơn bạn đã đăng ký nhận thông tin từ QTM!</p>
              )}
            </div>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <button onClick={scrollToTop} className="back-to-top-btn" aria-label="Cuộn lên đầu trang">
            Về đầu trang <i className="arrow-top">↑</i>
          </button>
        </div>
      </div>
    </footer>
