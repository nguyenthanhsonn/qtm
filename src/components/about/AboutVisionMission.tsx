...
export default function AboutVisionMission() {
  ...
  return (
    <section id="vision-mission" className="section section--about-vm">
      ...
      {/* Sparse particle network (lower density for this section) */}
      <ParticleField />
        ...
        >
          ...
          <motion.div variants={fadeUp} transition={{ duration: 0.6, ease: easeOut }}>
            ...
            >
              ...
              <p className="vm-card-highlight-sub">Trở thành Strategic MediaTech Partner hàng đầu Việt Nam</p>
          ...
          <motion.div variants={fadeUp} transition={{ duration: 0.6, ease: easeOut }}>
            ...
            >
              ...
              <p className="vm-card-highlight-sub">Kiến tạo giá trị bằng công nghệ, dữ liệu và sáng tạo</p>
              <p className="vm-card-text">
