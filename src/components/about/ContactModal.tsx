    ...
    <AnimatePresence>
      {isOpen && (
        <div
          ...
          aria-modal="true"
        >
          {/* Interactive Technology Grid Background with Mouse Cursor Reaction */}
          <div className={styles.backdropGridLayer} aria-hidden="true">
            <CursorGrid
              color="#38CFC8"
              cellSize={55}
              gridOpacity={0.12}
              ...
              clickPulse={true}
            />
            <div className={styles.techDataStreamOverlay} />
          </div>
              ...
              <div className={styles.modalBodyGrid}>
                ...
                <div className={styles.rightFormCol}>
                  <div className={styles.formTitleWrap}>
                    <h3 className={styles.formMainTitle}>{contextTitle}</h3>
                  ...
                  <form onSubmit={handleSubmit} className={styles.modalForm}>
                    ...
                    <div className={styles.inputGrid2Col}>
                      ...
                      <div className={styles.formGroup}>
                        <label htmlFor="modal-company">Doanh nghiệp *</label>
                        <input
                          id="modal-company"
                          type="text"
                          required
                      ...
                      <div className={styles.formGroup}>
                        <label htmlFor="modal-title">Chức vụ</label>
                        <input
                          id="modal-title"
                          type="text"
                    ...
                    <div className={styles.formGroup}>
                      <label htmlFor="modal-message">Mô tả nhu cầu chi tiết</label>
                      <textarea
                        id="modal-message"
                        rows={3}
